...
![access image](assets/img/access1.png){loading=lazy}

<br>

![access image](assets/img/access2.png){loading=lazy}
<br>


If you choose Phone or Tablet to save your passkey on your mobile device, open camera and scan the QR code:

![access image](assets/img/access3.png){loading=lazy}
<br>
...
![access image](assets/img/access4.png){loading=lazy}

Or Pin:

![access image](assets/img/access5.png){loading=lazy}

Or Camera:

![access image](assets/img/access6.png){loading=lazy}

If you choose “Hardware security key”, follow the on-screen instructions to register your security key. 

![access image](assets/img/access7.png){loading=lazy}

1. After registering, give your passkey a name. This step is optional.

![access image](assets/img/access8.png){loading=lazy}

![access image](assets/img/access9.png){loading=lazy}
<br>
...
![access image](assets/img/access10.png){loading=lazy}
